...
Nota de fase (Fases 1-4 del plan): ``ProcesoPLC``, ``ParamRealPLC``,
``ParamIntPLC`` y ``AlarmaPLC`` se re-exportan desde ``excel_cache``.
...
__all__ = [
    ...
    "DispM",
    "DispM_VF",
    # DTOs del Excel (Fases 1-4 del plan; Fase 5 amplía con dispositivos)
    "ProcesoPLC",
    "ParamRealPLC",
    "ParamIntPLC",
    "AlarmaPLC",
