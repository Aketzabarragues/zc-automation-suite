...
Punto crítico: el campo ``num_lista`` **no** se mapea con
``_safe_int`` (que destruiría los marcadores semánticos del operario
cayendo a ``0``). Se usa
...
class PRealParser:
    ...
    espacios) Ã¢â‚¬” exactamente como aparecen en el Excel del
