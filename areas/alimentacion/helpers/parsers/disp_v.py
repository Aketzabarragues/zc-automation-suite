...
departamento de alimentaciÃ³n y la mapea a una lista de ``DispV``.

Campos especÃ­ficos: ``S.Byte/S.Bit``, ``RR.Byte/RR.Bit``,
``RT.Byte/RT.Bit`` (retornos de reposo/trabajo) + 8 campos SCL
``cfg_*`` que preservan lÃ­neas SCL crudas (sin truncar).
