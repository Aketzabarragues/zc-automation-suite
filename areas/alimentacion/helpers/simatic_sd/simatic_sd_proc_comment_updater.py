...
Restricción arquitectónica (``.clinerules`` Â§1): este módulo es
...
class ProcCommentResult:
    ...
    satellite_reused: dict[int, str]  # slot â†’ mlc_id (uno por satélite)
...
class ProcCommentUpdater:
    ...
    def update(self) -> ProcCommentResult:
        ...
        # cabecera), los aÃ±adimos con texto "." (convención TIA).
    ...
    def _inject_mlc_block_or_assignment(
        ...
        - Si existe ``<ARRAY>[slot] := ...;`` sin bloque MLC â†’ aÃ±ade
          el bloque antes.
        - Si no existe la asignación â†’ aÃ±ade bloque + asignación al
        ...
        # Estrategia: aÃ±adir al final del bloque de inicialización,
    ...
    def _find_s7res_append_pos(self) -> int:
        """Encuentra la posición donde aÃ±adir una nueva entrada.
...
# â”€â”€ Helpers de módulo â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
