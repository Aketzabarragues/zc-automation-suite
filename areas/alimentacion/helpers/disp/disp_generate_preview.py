...
class DispPreviewContext:
    ...
    # Filtro opcional de hw_types para el preview (None = todos).
...
def _selective_table_names(
    ...
    siempre va al principio porque es config transversal y se evalua
    en Tx A independientemente de los devices seleccionados.
