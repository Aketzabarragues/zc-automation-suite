"""Motor puro de diffs para PlcUserConstant del área de alimentación.

Recibe el estado actual del PLC (exportado a XML o leído por COM) y el
estado deseado (del Excel), y devuelve la lista de operaciones necesarias
para sincronizar el PLC bajo una transacción atómica.

Este módulo es **específico del área de alimentación** (las PlcUserConstant
...
diffs equivalentes, se moverá a una ubicación compartida.
