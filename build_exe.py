...
HIDDEN_IMPORTS_AREAS: list[str] = [
    ...
    "areas.alimentacion.infrastructure.parsers.disp_dimensiones",
    "areas.alimentacion.infrastructure.parsers.proc_alarmas",
    "areas.alimentacion.infrastructure.parsers.proc_pint",
    "areas.alimentacion.infrastructure.parsers.proc_preal",
